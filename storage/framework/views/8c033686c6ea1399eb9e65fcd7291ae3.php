            ...
            <div class="form-container">
                <form action="<?php echo e(route('admin.berita.store')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="author" name="author" value="<?php echo e(old('author', auth()->user()->name)); ?>" required>
                    </div>
...
<?php /**PATH C:\Users\USER\Documents\GitHub\Desa-Kunyayan\resources\views/admin/berita/create.blade.php ENDPATH**/ ?>